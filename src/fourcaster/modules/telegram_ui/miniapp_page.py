...
A/E/S). Показывается качественной шкалой, а не числом: калибровки по факту ещё
нет (INV-6). Расчёт по разбросу, оставшийся в JS ниже, — запасной путь для
карточек, записанных до появления доменного модуля; его можно убрать, когда в
кэше не останется старых.
"""
